# result_tools.py - Documentation

## File Metadata
- **Path**: `tools/result_tools.py`
...
**Functions** (20): get_currency_symbol, calculate_portfolio_value, get_available_date_range, get_daily_portfolio_values, calculate_daily_returns, calculate_sharpe_ratio, calculate_max_drawdown, calculate_cumulative_return, calculate_annualized_return, calculate_volatility

**Imports** (15): Dict, Path, config, datetime, get_config_value, json, numpy, os, pandas, pathlib

## Detailed Walkthrough

This file contains 948 lines.

### Structure

- Function `get_currency_symbol` at line 23
- Function `calculate_portfolio_value` at line 28
- Function `get_available_date_range` at line 55
- Function `get_daily_portfolio_values` at line 100
- Function `calculate_daily_returns` at line 223
- Function `calculate_sharpe_ratio` at line 254
- Function `calculate_max_drawdown` at line 287
- Function `calculate_cumulative_return` at line 324
- Function `calculate_annualized_return` at line 349
- Function `calculate_volatility` at line 385
- Function `calculate_win_rate` at line 407
- Function `calculate_profit_loss_ratio` at line 426
- Function `calculate_all_metrics` at line 454
- Function `print_performance_report` at line 553
- Function `get_next_id` at line 606
- Function `save_metrics_to_jsonl` at line 635
- Function `get_latest_metrics` at line 717
- Function `get_metrics_history` at line 765
- Function `print_metrics_summary` at line 819
- Function `calculate_and_save_metrics` at line 868

## Keywords & Identifiers

- **CASH**: Constant in tools/result_tools.py
- **Dict**: Module imported in tools/result_tools.py
- **JSONL**: Constant in tools/result_tools.py
- **LOG_PATH**: Constant in tools/result_tools.py
- **MARKET**: Constant in tools/result_tools.py
- **Path**: Module imported in tools/result_tools.py
- **SIGNATURE**: Constant in tools/result_tools.py
- **YYYY**: Constant in tools/result_tools.py
- **calculate_all_metrics**: Function defined in tools/result_tools.py
- **calculate_and_save_metrics**: Function defined in tools/result_tools.py
- **calculate_annualized_return**: Function defined in tools/result_tools.py
- **calculate_cumulative_return**: Function defined in tools/result_tools.py
- **calculate_daily_returns**: Function defined in tools/result_tools.py
- **calculate_max_drawdown**: Function defined in tools/result_tools.py
- **calculate_portfolio_value**: Function defined in tools/result_tools.py
- **calculate_profit_loss_ratio**: Function defined in tools/result_tools.py
- **calculate_sharpe_ratio**: Function defined in tools/result_tools.py
- **calculate_volatility**: Function defined in tools/result_tools.py
- **calculate_win_rate**: Function defined in tools/result_tools.py
- **config**: Module imported in tools/result_tools.py
- **datetime**: Module imported in tools/result_tools.py
- **get_available_date_range**: Function defined in tools/result_tools.py
- **get_config_value**: Module imported in tools/result_tools.py
- **get_currency_symbol**: Function defined in tools/result_tools.py
- **get_daily_portfolio_values**: Function defined in tools/result_tools.py
- **get_latest_metrics**: Function defined in tools/result_tools.py
- **get_metrics_history**: Function defined in tools/result_tools.py
- **get_next_id**: Function defined in tools/result_tools.py
- **json**: Module imported in tools/result_tools.py
- **numpy**: Module imported in tools/result_tools.py
- **os**: Module imported in tools/result_tools.py
- **pandas**: Module imported in tools/result_tools.py
- **pathlib**: Module imported in tools/result_tools.py
- **print_metrics_summary**: Function defined in tools/result_tools.py
- **print_performance_report**: Function defined in tools/result_tools.py
- **save_metrics_to_jsonl**: Function defined in tools/result_tools.py
- **subdirectories**: Module imported in tools/result_tools.py
- **sys**: Module imported in tools/result_tools.py
- **tools.general_tools**: Module imported in tools/result_tools.py
- **tools.price_tools**: Module imported in tools/result_tools.py
- **typing**: Module imported in tools/result_tools.py
