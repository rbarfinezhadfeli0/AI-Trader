# daily_prices_INTC.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_INTC.json_docs.md`
...
```markdown
# daily_prices_INTC.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_INTC.json`
- **Type**: Binary
- **Size**: 37,883 bytes
- **Extension**: .json
