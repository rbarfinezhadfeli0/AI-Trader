...
## File Metadata
- **Path**: `data/agent_data_crypto/index.md`
...
```markdown
# data/agent_data_crypto - Index

**Path**: `data/agent_data_crypto`
...
- **MiniMax**: Identifier in data/agent_data_crypto/index.md

## Related Files

- Parent directory: [data/agent_data_crypto](../index.md)
