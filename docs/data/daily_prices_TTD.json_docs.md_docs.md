# daily_prices_TTD.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_TTD.json_docs.md`
...
```markdown
# daily_prices_TTD.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_TTD.json`
- **Type**: Binary
- **Size**: 37,707 bytes
- **Extension**: .json
