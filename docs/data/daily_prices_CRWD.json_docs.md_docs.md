# daily_prices_CRWD.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_CRWD.json_docs.md`
...
```markdown
# daily_prices_CRWD.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_CRWD.json`
- **Type**: Binary
- **Size**: 38,298 bytes
- **Extension**: .json
