# daily_prices_MNST.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_MNST.json_docs.md`
...
```markdown
# daily_prices_MNST.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_MNST.json`
- **Type**: Binary
- **Size**: 37,630 bytes
- **Extension**: .json
