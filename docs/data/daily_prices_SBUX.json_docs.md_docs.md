# daily_prices_SBUX.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_SBUX.json_docs.md`
...
```markdown
# daily_prices_SBUX.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_SBUX.json`
- **Type**: Binary
- **Size**: 37,705 bytes
- **Extension**: .json
