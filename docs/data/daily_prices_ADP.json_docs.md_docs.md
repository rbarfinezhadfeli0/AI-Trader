# daily_prices_ADP.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_ADP.json_docs.md`
...
```markdown
# daily_prices_ADP.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_ADP.json`
- **Type**: Binary
- **Size**: 38,260 bytes
- **Extension**: .json
