# daily_prices_GFS.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_GFS.json_docs.md`
...
```markdown
# daily_prices_GFS.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_GFS.json`
- **Type**: Binary
- **Size**: 37,609 bytes
- **Extension**: .json
