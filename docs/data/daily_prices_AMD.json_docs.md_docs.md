# daily_prices_AMD.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_AMD.json_docs.md`
...
```markdown
# daily_prices_AMD.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_AMD.json`
- **Type**: Binary
- **Size**: 38,513 bytes
- **Extension**: .json
