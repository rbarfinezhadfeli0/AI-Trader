# daily_prices_NFLX.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_NFLX.json_docs.md`
...
```markdown
# daily_prices_NFLX.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_NFLX.json`
- **Type**: Binary
- **Size**: 39,008 bytes
- **Extension**: .json
