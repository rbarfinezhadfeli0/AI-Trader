# daily_prices_MDLZ.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_MDLZ.json_docs.md`
...
```markdown
# daily_prices_MDLZ.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_MDLZ.json`
- **Type**: Binary
- **Size**: 37,670 bytes
- **Extension**: .json
