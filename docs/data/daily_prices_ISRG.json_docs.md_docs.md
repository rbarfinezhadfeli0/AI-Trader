# daily_prices_ISRG.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_ISRG.json_docs.md`
...
```markdown
# daily_prices_ISRG.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_ISRG.json`
- **Type**: Binary
- **Size**: 38,295 bytes
- **Extension**: .json
