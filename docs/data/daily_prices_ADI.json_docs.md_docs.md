# daily_prices_ADI.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_ADI.json_docs.md`
...
```markdown
# daily_prices_ADI.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_ADI.json`
- **Type**: Binary
- **Size**: 38,306 bytes
- **Extension**: .json
