# merge_crypto_jsonl.py - Documentation

## File Metadata
- **Path**: `data/crypto/merge_crypto_jsonl.py`
...
**Functions** (2): backup_crypto_data, verify_symbol_fixes

**Imports** (8): Path, dotenv, glob, json, load_dotenv, os, pathlib, shutil

## Detailed Walkthrough

This file contains 208 lines.

### Structure

- Function `backup_crypto_data` at line 42
- Function `verify_symbol_fixes` at line 55

## Keywords & Identifiers

- **ADA**: Constant in data/crypto/merge_crypto_jsonl.py
- **AVAX**: Constant in data/crypto/merge_crypto_jsonl.py
- **BTC**: Constant in data/crypto/merge_crypto_jsonl.py
- **DOT**: Constant in data/crypto/merge_crypto_jsonl.py
- **ETH**: Constant in data/crypto/merge_crypto_jsonl.py
- **JSON**: Constant in data/crypto/merge_crypto_jsonl.py
- **JSONL**: Constant in data/crypto/merge_crypto_jsonl.py
- **LINK**: Constant in data/crypto/merge_crypto_jsonl.py
- **LTC**: Constant in data/crypto/merge_crypto_jsonl.py
- **Path**: Module imported in data/crypto/merge_crypto_jsonl.py
- **SOL**: Constant in data/crypto/merge_crypto_jsonl.py
- **SUI**: Constant in data/crypto/merge_crypto_jsonl.py
- **SYMBOL**: Constant in data/crypto/merge_crypto_jsonl.py
- **USD**: Constant in data/crypto/merge_crypto_jsonl.py
- **USDT**: Constant in data/crypto/merge_crypto_jsonl.py
- **XRP**: Constant in data/crypto/merge_crypto_jsonl.py
- **backup_crypto_data**: Function defined in data/crypto/merge_crypto_jsonl.py
- **dotenv**: Module imported in data/crypto/merge_crypto_jsonl.py
- **glob**: Module imported in data/crypto/merge_crypto_jsonl.py
- **json**: Module imported in data/crypto/merge_crypto_jsonl.py
- **load_dotenv**: Module imported in data/crypto/merge_crypto_jsonl.py
- **os**: Module imported in data/crypto/merge_crypto_jsonl.py
- **pathlib**: Module imported in data/crypto/merge_crypto_jsonl.py
- **shutil**: Module imported in data/crypto/merge_crypto_jsonl.py
- **verify_symbol_fixes**: Function defined in data/crypto/merge_crypto_jsonl.py
