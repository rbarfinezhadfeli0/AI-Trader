# daily_prices_AAPL.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_AAPL.json_docs.md`
...
```markdown
# daily_prices_AAPL.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_AAPL.json`
- **Type**: Binary
- **Size**: 38,483 bytes
- **Extension**: .json
