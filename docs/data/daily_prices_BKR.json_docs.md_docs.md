# daily_prices_BKR.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_BKR.json_docs.md`
...
```markdown
# daily_prices_BKR.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_BKR.json`
- **Type**: Binary
- **Size**: 37,650 bytes
- **Extension**: .json
