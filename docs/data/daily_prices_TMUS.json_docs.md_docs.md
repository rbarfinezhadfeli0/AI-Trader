# daily_prices_TMUS.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_TMUS.json_docs.md`
...
```markdown
# daily_prices_TMUS.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_TMUS.json`
- **Type**: Binary
- **Size**: 38,319 bytes
- **Extension**: .json
