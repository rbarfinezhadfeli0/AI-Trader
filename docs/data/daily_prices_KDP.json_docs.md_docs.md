# daily_prices_KDP.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_KDP.json_docs.md`
...
```markdown
# daily_prices_KDP.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_KDP.json`
- **Type**: Binary
- **Size**: 37,746 bytes
- **Extension**: .json
