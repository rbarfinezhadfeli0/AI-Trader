# daily_prices_MU.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_MU.json_docs.md`
...
```markdown
# daily_prices_MU.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_MU.json`
- **Type**: Binary
- **Size**: 38,466 bytes
- **Extension**: .json
