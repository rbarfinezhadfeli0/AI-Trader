# daily_prices_ASML.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_ASML.json_docs.md`
...
```markdown
# daily_prices_ASML.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_ASML.json`
- **Type**: Binary
- **Size**: 38,802 bytes
- **Extension**: .json
