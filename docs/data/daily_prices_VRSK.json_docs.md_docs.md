# daily_prices_VRSK.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_VRSK.json_docs.md`
...
```markdown
# daily_prices_VRSK.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_VRSK.json`
- **Type**: Binary
- **Size**: 38,238 bytes
- **Extension**: .json
