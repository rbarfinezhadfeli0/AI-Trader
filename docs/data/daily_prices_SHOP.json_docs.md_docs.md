# daily_prices_SHOP.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_SHOP.json_docs.md`
...
```markdown
# daily_prices_SHOP.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_SHOP.json`
- **Type**: Binary
- **Size**: 38,378 bytes
- **Extension**: .json
