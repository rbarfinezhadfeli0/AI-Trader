# daily_prices_CSX.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_CSX.json_docs.md`
...
```markdown
# daily_prices_CSX.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_CSX.json`
- **Type**: Binary
- **Size**: 37,715 bytes
- **Extension**: .json
