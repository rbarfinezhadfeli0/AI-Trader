# daily_prices_DDOG.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_DDOG.json_docs.md`
...
```markdown
# daily_prices_DDOG.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_DDOG.json`
- **Type**: Binary
- **Size**: 38,323 bytes
- **Extension**: .json
