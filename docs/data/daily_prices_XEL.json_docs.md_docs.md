# daily_prices_XEL.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_XEL.json_docs.md`
...
```markdown
# daily_prices_XEL.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_XEL.json`
- **Type**: Binary
- **Size**: 37,614 bytes
- **Extension**: .json
