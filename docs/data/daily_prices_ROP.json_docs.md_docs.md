# daily_prices_ROP.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_ROP.json_docs.md`
...
```markdown
# daily_prices_ROP.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_ROP.json`
- **Type**: Binary
- **Size**: 38,209 bytes
- **Extension**: .json
