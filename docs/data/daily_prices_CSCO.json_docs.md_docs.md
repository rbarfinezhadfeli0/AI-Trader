# daily_prices_CSCO.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_CSCO.json_docs.md`
...
```markdown
# daily_prices_CSCO.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_CSCO.json`
- **Type**: Binary
- **Size**: 37,748 bytes
- **Extension**: .json
