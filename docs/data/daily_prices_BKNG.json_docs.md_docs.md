# daily_prices_BKNG.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_BKNG.json_docs.md`
...
```markdown
# daily_prices_BKNG.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_BKNG.json`
- **Type**: Binary
- **Size**: 38,784 bytes
- **Extension**: .json
