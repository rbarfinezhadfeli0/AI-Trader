# daily_prices_WDAY.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_WDAY.json_docs.md`
...
```markdown
# daily_prices_WDAY.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_WDAY.json`
- **Type**: Binary
- **Size**: 38,282 bytes
- **Extension**: .json
