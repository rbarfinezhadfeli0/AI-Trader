# daily_prices_ADSK.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_ADSK.json_docs.md`
...
```markdown
# daily_prices_ADSK.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_ADSK.json`
- **Type**: Binary
- **Size**: 38,208 bytes
- **Extension**: .json
