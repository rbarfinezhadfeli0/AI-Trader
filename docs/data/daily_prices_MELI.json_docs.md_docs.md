# daily_prices_MELI.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_MELI.json_docs.md`
...
```markdown
# daily_prices_MELI.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_MELI.json`
- **Type**: Binary
- **Size**: 38,856 bytes
- **Extension**: .json
