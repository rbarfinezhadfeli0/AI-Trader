# daily_prices_FTNT.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_FTNT.json_docs.md`
...
```markdown
# daily_prices_FTNT.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_FTNT.json`
- **Type**: Binary
- **Size**: 37,622 bytes
- **Extension**: .json
