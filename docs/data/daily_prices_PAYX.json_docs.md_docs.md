# daily_prices_PAYX.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_PAYX.json_docs.md`
...
```markdown
# daily_prices_PAYX.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_PAYX.json`
- **Type**: Binary
- **Size**: 38,302 bytes
- **Extension**: .json
