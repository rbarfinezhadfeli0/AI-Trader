# daily_prices_AMGN.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_AMGN.json_docs.md`
...
```markdown
# daily_prices_AMGN.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_AMGN.json`
- **Type**: Binary
- **Size**: 38,289 bytes
- **Extension**: .json
