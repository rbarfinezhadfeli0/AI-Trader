# daily_prices_CDW.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_CDW.json_docs.md`
...
```markdown
# daily_prices_CDW.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_CDW.json`
- **Type**: Binary
- **Size**: 38,248 bytes
- **Extension**: .json
