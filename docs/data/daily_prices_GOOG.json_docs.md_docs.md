# daily_prices_GOOG.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_GOOG.json_docs.md`
...
```markdown
# daily_prices_GOOG.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_GOOG.json`
- **Type**: Binary
- **Size**: 38,458 bytes
- **Extension**: .json
