# daily_prices_GEHC.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_GEHC.json_docs.md`
...
```markdown
# daily_prices_GEHC.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_GEHC.json`
- **Type**: Binary
- **Size**: 37,607 bytes
- **Extension**: .json
