# daily_prices_MSFT.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_MSFT.json_docs.md`
...
```markdown
# daily_prices_MSFT.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_MSFT.json`
- **Type**: Binary
- **Size**: 38,457 bytes
- **Extension**: .json
