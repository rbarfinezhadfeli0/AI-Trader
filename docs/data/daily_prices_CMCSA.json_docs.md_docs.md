# daily_prices_CMCSA.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_CMCSA.json_docs.md`
...
```markdown
# daily_prices_CMCSA.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_CMCSA.json`
- **Type**: Binary
- **Size**: 37,783 bytes
- **Extension**: .json
