# daily_prices_IDXX.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_IDXX.json_docs.md`
...
```markdown
# daily_prices_IDXX.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_IDXX.json`
- **Type**: Binary
- **Size**: 38,143 bytes
- **Extension**: .json
