# daily_prices_NVDA.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_NVDA.json_docs.md`
...
```markdown
# daily_prices_NVDA.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_NVDA.json`
- **Type**: Binary
- **Size**: 38,633 bytes
- **Extension**: .json
