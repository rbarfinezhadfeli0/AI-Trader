# daily_prices_CCEP.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_CCEP.json_docs.md`
...
```markdown
# daily_prices_CCEP.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_CCEP.json`
- **Type**: Binary
- **Size**: 37,574 bytes
- **Extension**: .json
