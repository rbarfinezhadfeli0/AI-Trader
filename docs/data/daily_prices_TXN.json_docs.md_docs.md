# daily_prices_TXN.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_TXN.json_docs.md`
...
```markdown
# daily_prices_TXN.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_TXN.json`
- **Type**: Binary
- **Size**: 38,347 bytes
- **Extension**: .json
