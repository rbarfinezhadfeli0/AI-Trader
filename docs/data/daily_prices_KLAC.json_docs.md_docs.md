# daily_prices_KLAC.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_KLAC.json_docs.md`
...
```markdown
# daily_prices_KLAC.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_KLAC.json`
- **Type**: Binary
- **Size**: 38,893 bytes
- **Extension**: .json
