# daily_prices_SNPS.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_SNPS.json_docs.md`
...
```markdown
# daily_prices_SNPS.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_SNPS.json`
- **Type**: Binary
- **Size**: 38,295 bytes
- **Extension**: .json
