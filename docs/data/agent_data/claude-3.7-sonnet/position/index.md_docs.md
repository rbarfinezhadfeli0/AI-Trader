...
## File Metadata
- **Path**: `data/agent_data/claude-3.7-sonnet/position/index.md`
...
```markdown
# data/agent_data/claude-3.7-sonnet/position - Index

**Path**: `data/agent_data/claude-3.7-sonnet/position`
