# daily_prices_AMAT.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_AMAT.json_docs.md`
...
```markdown
# daily_prices_AMAT.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_AMAT.json`
- **Type**: Binary
- **Size**: 38,350 bytes
- **Extension**: .json
