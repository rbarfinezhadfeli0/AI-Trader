# daily_prices_NXPI.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_NXPI.json_docs.md`
...
```markdown
# daily_prices_NXPI.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_NXPI.json`
- **Type**: Binary
- **Size**: 38,296 bytes
- **Extension**: .json
