# daily_prices_GOOGL.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_GOOGL.json_docs.md`
...
```markdown
# daily_prices_GOOGL.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_GOOGL.json`
- **Type**: Binary
- **Size**: 38,477 bytes
- **Extension**: .json
