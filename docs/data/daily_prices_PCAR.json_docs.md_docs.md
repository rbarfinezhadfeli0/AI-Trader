# daily_prices_PCAR.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_PCAR.json_docs.md`
...
```markdown
# daily_prices_PCAR.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_PCAR.json`
- **Type**: Binary
- **Size**: 37,689 bytes
- **Extension**: .json
