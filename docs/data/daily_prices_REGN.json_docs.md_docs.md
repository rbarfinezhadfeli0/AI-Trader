# daily_prices_REGN.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_REGN.json_docs.md`
...
```markdown
# daily_prices_REGN.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_REGN.json`
- **Type**: Binary
- **Size**: 38,203 bytes
- **Extension**: .json
