# daily_prices_TEAM.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_TEAM.json_docs.md`
...
```markdown
# daily_prices_TEAM.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_TEAM.json`
- **Type**: Binary
- **Size**: 38,307 bytes
- **Extension**: .json
