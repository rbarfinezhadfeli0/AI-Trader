# merge_jsonl_tushare.py - Documentation

## File Metadata
- **Path**: `data/A_stock/merge_jsonl_tushare.py`
...
**Functions** (1): convert_a_stock_to_jsonl

**Imports** (10): Any, Path, con_code, json, mapping, os, pandas, pathlib, sse_50_weight.csv, typing

## Detailed Walkthrough

This file contains 122 lines.

### Structure

- Function `convert_a_stock_to_jsonl` at line 9

## Keywords & Identifiers

- **Any**: Module imported in data/A_stock/merge_jsonl_tushare.py
- **CSV**: Constant in data/A_stock/merge_jsonl_tushare.py
- **JSON**: Constant in data/A_stock/merge_jsonl_tushare.py
- **JSONL**: Constant in data/A_stock/merge_jsonl_tushare.py
- **NASDAQ**: Constant in data/A_stock/merge_jsonl_tushare.py
- **Path**: Module imported in data/A_stock/merge_jsonl_tushare.py
- **SSE**: Constant in data/A_stock/merge_jsonl_tushare.py
- **con_code**: Module imported in data/A_stock/merge_jsonl_tushare.py
- **convert_a_stock_to_jsonl**: Function defined in data/A_stock/merge_jsonl_tushare.py
- **json**: Module imported in data/A_stock/merge_jsonl_tushare.py
- **mapping**: Module imported in data/A_stock/merge_jsonl_tushare.py
- **os**: Module imported in data/A_stock/merge_jsonl_tushare.py
- **pandas**: Module imported in data/A_stock/merge_jsonl_tushare.py
- **pathlib**: Module imported in data/A_stock/merge_jsonl_tushare.py
- **sse_50_weight.csv**: Module imported in data/A_stock/merge_jsonl_tushare.py
- **typing**: Module imported in data/A_stock/merge_jsonl_tushare.py
