# get_daily_price_tushare.py - Documentation

## File Metadata
- **Path**: `data/A_stock/get_daily_price_tushare.py`
- **Size**: 13,332 bytes (13.02 KB)
- **Extension**: .py
- **Type**: Text file
...
**Functions** (6): get_last_month_dates, calculate_batch_days, api_call_with_retry, get_daily_price_a_stock, convert_index_daily_to_json, get_index_daily_data

**Imports** (18): Dict, Path, daily_start_date, datetime, dotenv, fallback, json, last, load_dotenv, os

## Detailed Walkthrough

This file contains 377 lines.

### Structure

- Function `get_last_month_dates` at line 15
- Function `calculate_batch_days` at line 32
- Function `api_call_with_retry` at line 45
- Function `get_daily_price_a_stock` at line 109
- Function `convert_index_daily_to_json` at line 238
- Function `get_index_daily_data` at line 300

## Keywords & Identifiers

- **API**: Constant in data/A_stock/get_daily_price_tushare.py
- **CSV**: Constant in data/A_stock/get_daily_price_tushare.py
- **ConnectionError**: Identifier in data/A_stock/get_daily_price_tushare.py
- **DataFrame**: Identifier in data/A_stock/get_daily_price_tushare.py
- **Dict**: Module imported in data/A_stock/get_daily_price_tushare.py
- **JSON**: Constant in data/A_stock/get_daily_price_tushare.py
- **Path**: Module imported in data/A_stock/get_daily_price_tushare.py
- **ReadTimeout**: Identifier in data/A_stock/get_daily_price_tushare.py
- **SSE**: Constant in data/A_stock/get_daily_price_tushare.py
- **TUSHARE_TOKEN**: Constant in data/A_stock/get_daily_price_tushare.py
- **YYYYMMDD**: Constant in data/A_stock/get_daily_price_tushare.py
- **api_call_with_retry**: Function defined in data/A_stock/get_daily_price_tushare.py
- **calculate_batch_days**: Function defined in data/A_stock/get_daily_price_tushare.py
- **convert_index_daily_to_json**: Function defined in data/A_stock/get_daily_price_tushare.py
- **daily_start_date**: Module imported in data/A_stock/get_daily_price_tushare.py
- **datetime**: Module imported in data/A_stock/get_daily_price_tushare.py
- **dotenv**: Module imported in data/A_stock/get_daily_price_tushare.py
- **fallback**: Module imported in data/A_stock/get_daily_price_tushare.py
- **get_daily_price_a_stock**: Function defined in data/A_stock/get_daily_price_tushare.py
- **get_index_daily_data**: Function defined in data/A_stock/get_daily_price_tushare.py
- **get_last_month_dates**: Function defined in data/A_stock/get_daily_price_tushare.py
- **json**: Module imported in data/A_stock/get_daily_price_tushare.py
- **last**: Module imported in data/A_stock/get_daily_price_tushare.py
- **load_dotenv**: Module imported in data/A_stock/get_daily_price_tushare.py
- **os**: Module imported in data/A_stock/get_daily_price_tushare.py
- **pandas**: Module imported in data/A_stock/get_daily_price_tushare.py
- **pathlib**: Module imported in data/A_stock/get_daily_price_tushare.py
- **pro.index_daily**: Module imported in data/A_stock/get_daily_price_tushare.py
- **requests**: Module imported in data/A_stock/get_daily_price_tushare.py
- **the**: Module imported in data/A_stock/get_daily_price_tushare.py
- **time**: Module imported in data/A_stock/get_daily_price_tushare.py
- **tushare**: Module imported in data/A_stock/get_daily_price_tushare.py
- **typing**: Module imported in data/A_stock/get_daily_price_tushare.py
