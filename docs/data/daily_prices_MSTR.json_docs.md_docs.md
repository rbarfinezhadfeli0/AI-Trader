# daily_prices_MSTR.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_MSTR.json_docs.md`
...
```markdown
# daily_prices_MSTR.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_MSTR.json`
- **Type**: Binary
- **Size**: 38,412 bytes
- **Extension**: .json
