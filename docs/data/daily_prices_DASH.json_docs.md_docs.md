# daily_prices_DASH.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_DASH.json_docs.md`
...
```markdown
# daily_prices_DASH.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_DASH.json`
- **Type**: Binary
- **Size**: 38,314 bytes
- **Extension**: .json
