# daily_prices_MAR.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_MAR.json_docs.md`
...
```markdown
# daily_prices_MAR.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_MAR.json`
- **Type**: Binary
- **Size**: 38,256 bytes
- **Extension**: .json
