# daily_prices_ARM.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_ARM.json_docs.md`
...
```markdown
# daily_prices_ARM.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_ARM.json`
- **Type**: Binary
- **Size**: 38,326 bytes
- **Extension**: .json
