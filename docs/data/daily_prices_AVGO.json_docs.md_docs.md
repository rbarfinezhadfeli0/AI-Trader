# daily_prices_AVGO.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_AVGO.json_docs.md`
...
```markdown
# daily_prices_AVGO.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_AVGO.json`
- **Type**: Binary
- **Size**: 38,461 bytes
- **Extension**: .json
