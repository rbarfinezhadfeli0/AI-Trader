# daily_prices_CSGP.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_CSGP.json_docs.md`
...
```markdown
# daily_prices_CSGP.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_CSGP.json`
- **Type**: Binary
- **Size**: 37,618 bytes
- **Extension**: .json
