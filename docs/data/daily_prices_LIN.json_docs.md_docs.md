# daily_prices_LIN.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_LIN.json_docs.md`
...
```markdown
# daily_prices_LIN.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_LIN.json`
- **Type**: Binary
- **Size**: 38,279 bytes
- **Extension**: .json
