# daily_prices_LRCX.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_LRCX.json_docs.md`
...
```markdown
# daily_prices_LRCX.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_LRCX.json`
- **Type**: Binary
- **Size**: 38,391 bytes
- **Extension**: .json
