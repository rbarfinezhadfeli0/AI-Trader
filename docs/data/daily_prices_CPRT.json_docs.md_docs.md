# daily_prices_CPRT.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_CPRT.json_docs.md`
...
```markdown
# daily_prices_CPRT.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_CPRT.json`
- **Type**: Binary
- **Size**: 37,639 bytes
- **Extension**: .json
