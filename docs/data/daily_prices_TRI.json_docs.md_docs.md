# daily_prices_TRI.json_docs.md - Documentation

## File Metadata
- **Path**: `data/daily_prices_TRI.json_docs.md`
...
```markdown
# daily_prices_TRI.json - Binary File Documentation

## File Metadata
- **Path**: `data/daily_prices_TRI.json`
- **Type**: Binary
- **Size**: 38,234 bytes
- **Extension**: .json
