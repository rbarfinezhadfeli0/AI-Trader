# tool_crypto_trade.py - Documentation

## File Metadata
- **Path**: `agent_tools/tool_crypto_trade.py`
- **Size**: 14,382 bytes (14.04 KB)
- **Extension**: .py
- **Type**: Text file
...
**Functions** (6): _position_lock, __init__, __enter__, __exit__, buy_crypto, sell_crypto

**Imports** (15): Any, Dict, FastMCP, Path, environment, fastmcp, fcntl, get_config_value, json, os

## Detailed Walkthrough

This file contains 335 lines.

### Structure

- Function `_position_lock` at line 23
- **Line 25**: Class `_Lock` definition
  - Method `__init__` at line 26
  - Method `__enter__` at line 32
  - Method `__exit__` at line 35
  - Method `buy_crypto` at line 45
  - Method `sell_crypto` at line 186

## Keywords & Identifiers

- **Any**: Module imported in agent_tools/tool_crypto_trade.py
- **BTC**: Constant in agent_tools/tool_crypto_trade.py
- **CASH**: Constant in agent_tools/tool_crypto_trade.py
- **CRYPTO_HTTP_PORT**: Constant in agent_tools/tool_crypto_trade.py
- **CryptoTradeTools**: Identifier in agent_tools/tool_crypto_trade.py
- **Dict**: Module imported in agent_tools/tool_crypto_trade.py
- **ETH**: Constant in agent_tools/tool_crypto_trade.py
- **FastMCP**: Module imported in agent_tools/tool_crypto_trade.py
- **IF_TRADE**: Constant in agent_tools/tool_crypto_trade.py
- **JSON**: Constant in agent_tools/tool_crypto_trade.py
- **KeyError**: Identifier in agent_tools/tool_crypto_trade.py
- **LOCK_EX**: Constant in agent_tools/tool_crypto_trade.py
- **LOCK_UN**: Constant in agent_tools/tool_crypto_trade.py
- **LOG_PATH**: Constant in agent_tools/tool_crypto_trade.py
- **Path**: Module imported in agent_tools/tool_crypto_trade.py
- **SIGNATURE**: Constant in agent_tools/tool_crypto_trade.py
- **TODAY_DATE**: Constant in agent_tools/tool_crypto_trade.py
- **USDT**: Constant in agent_tools/tool_crypto_trade.py
- **ValueError**: Identifier in agent_tools/tool_crypto_trade.py
- **_Lock**: Class defined in agent_tools/tool_crypto_trade.py
- **__enter__**: Function defined in agent_tools/tool_crypto_trade.py
- **__exit__**: Function defined in agent_tools/tool_crypto_trade.py
- **__init__**: Function defined in agent_tools/tool_crypto_trade.py
- **_position_lock**: Function defined in agent_tools/tool_crypto_trade.py
- **buy_crypto**: Function defined in agent_tools/tool_crypto_trade.py
- **environment**: Module imported in agent_tools/tool_crypto_trade.py
- **fastmcp**: Module imported in agent_tools/tool_crypto_trade.py
- **fcntl**: Module imported in agent_tools/tool_crypto_trade.py
- **get_config_value**: Module imported in agent_tools/tool_crypto_trade.py
- **json**: Module imported in agent_tools/tool_crypto_trade.py
- **os**: Module imported in agent_tools/tool_crypto_trade.py
- **pathlib**: Module imported in agent_tools/tool_crypto_trade.py
- **sell_crypto**: Function defined in agent_tools/tool_crypto_trade.py
- **sys**: Module imported in agent_tools/tool_crypto_trade.py
- **tools.general_tools**: Module imported in agent_tools/tool_crypto_trade.py
- **tools.price_tools**: Module imported in agent_tools/tool_crypto_trade.py
- **typing**: Module imported in agent_tools/tool_crypto_trade.py
