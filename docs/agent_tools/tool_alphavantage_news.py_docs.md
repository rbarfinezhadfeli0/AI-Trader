# tool_alphavantage_news.py - Documentation

## File Metadata
- **Path**: `agent_tools/tool_alphavantage_news.py`
- **Size**: 12,161 bytes (11.88 KB)
- **Extension**: .py
- **Type**: Text file
...
**Classes** (1): AlphaVantageNewsTool

**Functions** (5): parse_date_to_standard, __init__, _fetch_news, __call__, get_market_news

**Imports** (17): Alpha, Any, FastMCP, datetime, dotenv, fastmcp, get_config_value, if, json, load_dotenv

## Detailed Walkthrough

This file contains 319 lines.

### Structure

- Function `parse_date_to_standard` at line 20
- **Line 88**: Class `AlphaVantageNewsTool` definition
  - Method `__init__` at line 89
  - Method `_fetch_news` at line 97
  - Method `__call__` at line 162
  - Method `get_market_news` at line 223

## Keywords & Identifiers

- **AAPL**: Constant in agent_tools/tool_alphavantage_news.py
- **ALPHAADVANTAGE_API_KEY**: Constant in agent_tools/tool_alphavantage_news.py
- **API**: Constant in agent_tools/tool_alphavantage_news.py
- **Alpha**: Module imported in agent_tools/tool_alphavantage_news.py
- **AlphaVantageNewsTool**: Identifier in agent_tools/tool_alphavantage_news.py
- **Any**: Module imported in agent_tools/tool_alphavantage_news.py
- **BTC**: Constant in agent_tools/tool_alphavantage_news.py
- **COIN**: Constant in agent_tools/tool_alphavantage_news.py
- **CRYPTO**: Constant in agent_tools/tool_alphavantage_news.py
- **EARLIEST**: Constant in agent_tools/tool_alphavantage_news.py
- **FOREX**: Constant in agent_tools/tool_alphavantage_news.py
- **FastMCP**: Module imported in agent_tools/tool_alphavantage_news.py
- **ISO**: Constant in agent_tools/tool_alphavantage_news.py
- **LATEST**: Constant in agent_tools/tool_alphavantage_news.py
- **NEWS_SENTIMENT**: Constant in agent_tools/tool_alphavantage_news.py
- **RELEVANCE**: Constant in agent_tools/tool_alphavantage_news.py
- **RequestException**: Identifier in agent_tools/tool_alphavantage_news.py
- **SEARCH_HTTP_PORT**: Constant in agent_tools/tool_alphavantage_news.py
- **TODAY_DATE**: Constant in agent_tools/tool_alphavantage_news.py
- **URL**: Constant in agent_tools/tool_alphavantage_news.py
- **USD**: Constant in agent_tools/tool_alphavantage_news.py
- **ValueError**: Identifier in agent_tools/tool_alphavantage_news.py
- **YYYY**: Constant in agent_tools/tool_alphavantage_news.py
- **YYYYMMDDTHHMM**: Constant in agent_tools/tool_alphavantage_news.py
- **YYYYMMDDTHHMMSS**: Constant in agent_tools/tool_alphavantage_news.py
- **__call__**: Function defined in agent_tools/tool_alphavantage_news.py
- **__init__**: Function defined in agent_tools/tool_alphavantage_news.py
- **_fetch_news**: Function defined in agent_tools/tool_alphavantage_news.py
- **datetime**: Module imported in agent_tools/tool_alphavantage_news.py
- **dotenv**: Module imported in agent_tools/tool_alphavantage_news.py
- **fastmcp**: Module imported in agent_tools/tool_alphavantage_news.py
- **get_config_value**: Module imported in agent_tools/tool_alphavantage_news.py
- **get_market_news**: Function defined in agent_tools/tool_alphavantage_news.py
- **if**: Module imported in agent_tools/tool_alphavantage_news.py
- **json**: Module imported in agent_tools/tool_alphavantage_news.py
- **load_dotenv**: Module imported in agent_tools/tool_alphavantage_news.py
- **logging**: Module imported in agent_tools/tool_alphavantage_news.py
- **os**: Module imported in agent_tools/tool_alphavantage_news.py
- **parse_date_to_standard**: Function defined in agent_tools/tool_alphavantage_news.py
- **requests**: Module imported in agent_tools/tool_alphavantage_news.py
- **sys**: Module imported in agent_tools/tool_alphavantage_news.py
- **to**: Module imported in agent_tools/tool_alphavantage_news.py
- **tools.general_tools**: Module imported in agent_tools/tool_alphavantage_news.py
- **typing**: Module imported in agent_tools/tool_alphavantage_news.py
