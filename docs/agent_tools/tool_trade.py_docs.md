# tool_trade.py - Documentation

## File Metadata
- **Path**: `agent_tools/tool_trade.py`
- **Size**: 17,154 bytes (16.75 KB)
- **Extension**: .py
- **Type**: Text file
...
**Functions** (7): _position_lock, __init__, __enter__, __exit__, buy, _get_today_buy_amount, sell

**Imports** (15): Any, Dict, FastMCP, Path, environment, fastmcp, fcntl, get_config_value, json, os

## Detailed Walkthrough

This file contains 413 lines.
...
- **Line 25**: Class `_Lock` definition
  ...
  - Method `buy` at line 45
  - Method `_get_today_buy_amount` at line 200
  - Method `sell` at line 238

## Keywords & Identifiers

- **AAPL**: Constant in agent_tools/tool_trade.py
- **Any**: Module imported in agent_tools/tool_trade.py
- **CASH**: Constant in agent_tools/tool_trade.py
- **Dict**: Module imported in agent_tools/tool_trade.py
- **FastMCP**: Module imported in agent_tools/tool_trade.py
- **IF_TRADE**: Constant in agent_tools/tool_trade.py
- **JSON**: Constant in agent_tools/tool_trade.py
- **KeyError**: Identifier in agent_tools/tool_trade.py
- **LOCK_EX**: Constant in agent_tools/tool_trade.py
- **LOCK_UN**: Constant in agent_tools/tool_trade.py
- **LOG_PATH**: Constant in agent_tools/tool_trade.py
- **MSFT**: Constant in agent_tools/tool_trade.py
- **Path**: Module imported in agent_tools/tool_trade.py
- **SIGNATURE**: Constant in agent_tools/tool_trade.py
- **TODAY_DATE**: Constant in agent_tools/tool_trade.py
- **TRADE_HTTP_PORT**: Constant in agent_tools/tool_trade.py
- **TradeTools**: Identifier in agent_tools/tool_trade.py
- **ValueError**: Identifier in agent_tools/tool_trade.py
- **_Lock**: Class defined in agent_tools/tool_trade.py
- **__enter__**: Function defined in agent_tools/tool_trade.py
- **__exit__**: Function defined in agent_tools/tool_trade.py
- **__init__**: Function defined in agent_tools/tool_trade.py
- **_get_today_buy_amount**: Function defined in agent_tools/tool_trade.py
- **_position_lock**: Function defined in agent_tools/tool_trade.py
- **buy**: Function defined in agent_tools/tool_trade.py
- **environment**: Module imported in agent_tools/tool_trade.py
- **fastmcp**: Module imported in agent_tools/tool_trade.py
- **fcntl**: Module imported in agent_tools/tool_trade.py
- **get_config_value**: Module imported in agent_tools/tool_trade.py
- **json**: Module imported in agent_tools/tool_trade.py
- **os**: Module imported in agent_tools/tool_trade.py
- **pathlib**: Module imported in agent_tools/tool_trade.py
- **sell**: Function defined in agent_tools/tool_trade.py
- **sys**: Module imported in agent_tools/tool_trade.py
- **tools.general_tools**: Module imported in agent_tools/tool_trade.py
- **tools.price_tools**: Module imported in agent_tools/tool_trade.py
- **typing**: Module imported in agent_tools/tool_trade.py
