# base_agent_crypto.py - Documentation

## File Metadata
- **Path**: `agent/base_agent_crypto/base_agent_crypto.py`
...
**Classes** (4): for, DeepSeekChatOpenAI, BaseAgentCrypto, for
...
**Imports** (27): AIMessage, Any, ChatOpenAI, MultiServerMCPClient, Path, STOP_SIGNAL, add_no_trade_record, asyncio, convert_to_openai_tool, create_agent

## Detailed Walkthrough

This file contains 547 lines.

### Structure

- **Line 26**: Class `DeepSeekChatOpenAI` definition
  - Method `_create_message_dicts` at line 32
  - Method `_generate` at line 37
- **Line 93**: Class `BaseAgentCrypto` definition
  - Method `__init__` at line 117
  - Method `_get_default_mcp_config` at line 193
  - Method `_setup_logging` at line 272
  - Method `_log_message` at line 279
  - Method `register_agent` at line 387
  - Method `get_trading_dates` at line 413
  - Method `get_position_summary` at line 520
  - Method `__str__` at line 541
  - Method `__repr__` at line 546

## Keywords & Identifiers

- **ADA**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **AIMessage**: Module imported in agent/base_agent_crypto/base_agent_crypto.py
- **API**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **AVAX**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **Any**: Module imported in agent/base_agent_crypto/base_agent_crypto.py
- **BTC**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **BaseAgentCrypto**: Identifier in agent/base_agent_crypto/base_agent_crypto.py
- **CASH**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **CRYPTO_HTTP_PORT**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **ChatOpenAI**: Module imported in agent/base_agent_crypto/base_agent_crypto.py
- **CoinDesk**: Identifier in agent/base_agent_crypto/base_agent_crypto.py
- **DEFAULT_CRYPTO_SYMBOLS**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **DOGE**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **DOT**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **DeepSeek**: Identifier in agent/base_agent_crypto/base_agent_crypto.py
- **DeepSeekChatOpenAI**: Class defined in agent/base_agent_crypto/base_agent_crypto.py
- **ETH**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **GETPRICE_HTTP_PORT**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **IF_TRADE**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **JSON**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **LINK**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **LOG_FILE**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **MATH_HTTP_PORT**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **MATIC**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **MCP**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **MultiServerMCPClient**: Module imported in agent/base_agent_crypto/base_agent_crypto.py
- **NameError**: Identifier in agent/base_agent_crypto/base_agent_crypto.py
- **OPENAI_API_BASE**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **OPENAI_API_KEY**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **Path**: Module imported in agent/base_agent_crypto/base_agent_crypto.py
- **RuntimeError**: Identifier in agent/base_agent_crypto/base_agent_crypto.py
- **SEARCH_HTTP_PORT**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **SIGNATURE**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **SOL**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **STOP_SIGNAL**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **TODAY_DATE**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **URL**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **USDT**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **ValueError**: Identifier in agent/base_agent_crypto/base_agent_crypto.py
- **XRP**: Constant in agent/base_agent_crypto/base_agent_crypto.py
- **__init__**: Function defined in agent/base_agent_crypto/base_agent_crypto.py
- **__repr__**: Function defined in agent/base_agent_crypto/base_agent_crypto.py
- **__str__**: Function defined in agent/base_agent_crypto/base_agent_crypto.py
- **_agenerate**: Function defined in agent/base_agent_crypto/base_agent_crypto.py
- **_ainvoke_with_retry**: Function defined in agent/base_agent_crypto/base_agent_crypto.py
- **_create_message_dicts**: Function defined in agent/base_agent_crypto/base_agent_crypto.py
- **_generate**: Function defined in agent/base_agent_crypto/base_agent_crypto.py
- **_get_default_mcp_config**: Function defined in agent/base_agent_crypto/base_agent_crypto.py
- **_handle_trading_result**: Function defined in agent/base_agent_crypto/base_agent_crypto.py
- **_log_message**: Function defined in agent/base_agent_crypto/base_agent_crypto.py

## Related Files

- Parent directory: [agent/base_agent_crypto](../index.md)
