# base_agent.py - Documentation

## File Metadata
- **Path**: `agent/base_agent/base_agent.py`
- **Size**: 25,304 bytes (24.71 KB)
- **Extension**: .py
- **Type**: Text file
...
**Classes** (4): for, DeepSeekChatOpenAI, BaseAgent, for
...
**Imports** (35): AIMessage, Any, ChatOpenAI, MultiServerMCPClient, Path, STOP_SIGNAL, StdOutCallbackHandler, add_no_trade_record, all_sse_50_symbols, asyncio

## Detailed Walkthrough

This file contains 696 lines.

### Structure

- **Line 39**: Class `DeepSeekChatOpenAI` definition
  - Method `_create_message_dicts` at line 45
  - Method `_generate` at line 50
- **Line 106**: Class `BaseAgent` definition
  - Method `__init__` at line 223
  - Method `_get_default_mcp_config` at line 309
  - Method `_setup_logging` at line 406
  - Method `_log_message` at line 413
  - Method `register_agent` at line 536
  - Method `get_trading_dates` at line 562
  - Method `get_position_summary` at line 669
  - Method `__str__` at line 690
  - Method `__repr__` at line 695

## Keywords & Identifiers

- **AAPL**: Constant in agent/base_agent/base_agent.py
- **ABNB**: Constant in agent/base_agent/base_agent.py
- **ADBE**: Constant in agent/base_agent/base_agent.py
- **ADI**: Constant in agent/base_agent/base_agent.py
- **ADP**: Constant in agent/base_agent/base_agent.py
- **ADSK**: Constant in agent/base_agent/base_agent.py
- **AEP**: Constant in agent/base_agent/base_agent.py
- **AIMessage**: Module imported in agent/base_agent/base_agent.py
- **AMAT**: Constant in agent/base_agent/base_agent.py
- **AMD**: Constant in agent/base_agent/base_agent.py
- **AMGN**: Constant in agent/base_agent/base_agent.py
- **AMZN**: Constant in agent/base_agent/base_agent.py
- **API**: Constant in agent/base_agent/base_agent.py
- **APP**: Constant in agent/base_agent/base_agent.py
- **ARM**: Constant in agent/base_agent/base_agent.py
- **ASML**: Constant in agent/base_agent/base_agent.py
- **AVGO**: Constant in agent/base_agent/base_agent.py
- **AXON**: Constant in agent/base_agent/base_agent.py
- **AZN**: Constant in agent/base_agent/base_agent.py
- **Any**: Module imported in agent/base_agent/base_agent.py
- **BIIB**: Constant in agent/base_agent/base_agent.py
- **BKNG**: Constant in agent/base_agent/base_agent.py
- **BKR**: Constant in agent/base_agent/base_agent.py
- **BaseAgent**: Identifier in agent/base_agent/base_agent.py
- **CASH**: Constant in agent/base_agent/base_agent.py
- **CCEP**: Constant in agent/base_agent/base_agent.py
- **CDNS**: Constant in agent/base_agent/base_agent.py
- **CDW**: Constant in agent/base_agent/base_agent.py
- **CEG**: Constant in agent/base_agent/base_agent.py
- **CHTR**: Constant in agent/base_agent/base_agent.py
- **CMCSA**: Constant in agent/base_agent/base_agent.py
- **COST**: Constant in agent/base_agent/base_agent.py
- **CPRT**: Constant in agent/base_agent/base_agent.py
- **CRWD**: Constant in agent/base_agent/base_agent.py
- **CSCO**: Constant in agent/base_agent/base_agent.py
- **CSGP**: Constant in agent/base_agent/base_agent.py
- **CSX**: Constant in agent/base_agent/base_agent.py
- **CTAS**: Constant in agent/base_agent/base_agent.py
- **CTSH**: Constant in agent/base_agent/base_agent.py
- **ChatOpenAI**: Module imported in agent/base_agent/base_agent.py
- **DASH**: Constant in agent/base_agent/base_agent.py
- **DDOG**: Constant in agent/base_agent/base_agent.py
- **DEFAULT_STOCK_SYMBOLS**: Constant in agent/base_agent/base_agent.py
- **DXCM**: Constant in agent/base_agent/base_agent.py
- **DeepSeek**: Identifier in agent/base_agent/base_agent.py
- **DeepSeekChatOpenAI**: Class defined in agent/base_agent/base_agent.py
- **EXC**: Constant in agent/base_agent/base_agent.py
- **FANG**: Constant in agent/base_agent/base_agent.py
- **FAST**: Constant in agent/base_agent/base_agent.py
- **FTNT**: Constant in agent/base_agent/base_agent.py

## Related Files

- Parent directory: [agent/base_agent](../index.md)
